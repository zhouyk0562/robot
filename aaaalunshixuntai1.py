...
THRESHOLD_FRONT = 1480  # 前方灰度阈值
THRESHOLD_REAR  = 2278   # 后方灰度阈值
THRESHOLD_LEFT  = 1280   # 左侧灰度阈值
...
TURN_LEFT_SPEED  = -600   # 转弯时左轮速度
TURN_RIGHT_SPEED = 600    # 转弯时右轮速度

# 动作持续时间（秒）
BACK_DURATION  = 0.5      # 后退时长
TURN_DURATION  = 0.7      # 转弯时长（角度微调）
# ================================
